...
function App() {
  ...
  const handleNavigate = (page: string) => {
    ...
    if (validPage === 'docs' || validPage === 'strategies' || validPage === 'videos' || validPage === 'blog') {
  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      case 'docs':
        return <Docs onNavigate={handleNavigate} initialDoc={subPaths.join('/')} />;
      case 'strategies':
        return <Strategies onNavigate={handleNavigate} initialStrategy={subPaths.join('/')} />;
      case 'videos':
        return <Videos onNavigate={handleNavigate} selectedVideo={subPaths.join('/')} />;
      case 'blog':
        return <Blog onNavigate={handleNavigate} selectedPost={subPaths.join('/')} />;
      default:
        return <Home />;
    }
  };
