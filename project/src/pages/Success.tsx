...
import { CheckCircle, Copy, Check, AlertCircle } from 'lucide-react';
...
export function Success() {
  ...
  const fetchLicense = async (id: string) => {
    try {
      const response = await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/get-license?session_id=${id}`, {
        headers: {
              ...
              <div className="bg-[#0f0f0f] border border-[#3d3d3d] rounded-lg p-4">
                ...
                <ol className="text-left space-y-2 text-gray-300 text-sm">
                  <li className="flex gap-2">
                    ...
                    <span>Download S2N Navigator from the link in your email</span>
                  </li>
                  <li className="flex gap-2">
